...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.BlogPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.Cliente", b =>
                {
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.Endereco", b =>
                {
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.OrdemServico", b =>
                {
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.OrdemServicoPeca", b =>
                {
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.Peca", b =>
                {
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.TipoUsuario", b =>
                {
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.Usuario", b =>
                {
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.Veiculo", b =>
                {
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.Endereco", b =>
                {
                    b.HasOne("Garagem75.Shared.Models.Cliente", "Cliente")
                        .WithMany("Enderecos")
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.OrdemServico", b =>
                {
                    b.HasOne("Garagem75.Shared.Models.Veiculo", "Veiculo")
                        .WithMany()
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.OrdemServicoPeca", b =>
                {
                    b.HasOne("Garagem75.Shared.Models.OrdemServico", "OrdemServico")
                        .WithMany("PecasAssociadas")
                        .HasForeignKey("OrdemServicoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Garagem75.Shared.Models.Peca", "Peca")
                        .WithMany()
                        .HasForeignKey("PecaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Garagem75.Shared.Models.Peca", null)
                        .WithMany("PecasAssociadas")
            ...
            modelBuilder.Entity("Garagem75.Shared.Models.Usuario", b =>
                {
                    b.HasOne("Garagem75.Shared.Models.TipoUsuario", "TipoUsuario")
                        .WithMany("Usuarios")
